...
isl_2020.map(obj=>obj.team).forEach(team=>console.log(team))
isl_2020.sort((obj1,obj2)=>obj1.mp>obj2.mp?1:-1).forEach(obj=>console.log(obj))
let high_point=isl_2020.map(obj=>obj.pts).reduce((pt1,pt2)=>(pt1>pt2)?pt1:pt2)
console.log(high_point);
high_point_sort=isl_2020.sort((obj1,obj2)=>obj1.pts>obj2.pts?-1:1)[0]
console.log(high_point_sort);
